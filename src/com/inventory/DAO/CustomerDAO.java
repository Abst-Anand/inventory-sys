...
public class CustomerDAO {
    ...
    public ResultSet getQueryResult() {
        try {
            String query = "SELECT cid as `Customer ID`,customercode,fullname,location,phone FROM customers";
            resultSet = statement.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public ResultSet getCustById(String custId) {
        try {
            String query = "SELECT * FROM customers WHERE cid='" +custId+ "'";
            resultSet = statement.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public String getCustCodeFromId(String custId){
        String custCode="";

        try{
            String query = "Select customercode from customers where cid=" +custId;
            System.out.println(query);
            resultSet = statement.executeQuery(query);
            custCode = resultSet.getString("customercode");
            System.out.println(custId + " " + custCode);
    ...
    public ResultSet getCustNameFromId(String custId) {
        try {
            String query = "SELECT * FROM customers WHERE cid='" +custId+ "'";
            resultSet = statement.executeQuery(query);
        } catch (SQLException e) {
    ...
    public ResultSet getCustIdFromName(String name) {
        try {
