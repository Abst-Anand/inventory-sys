...
public class PurchasePage extends javax.swing.JPanel {
    ...
    private void downloadButtonActionPerformed(java.awt.event.ActionEvent evt){
        String tableHeading = "Purchase Report";
        PdfExporter.exportToPDF(purchaseTable, tableHeading);
    }
    ...
    public void loadDataSet() {
        try {
            ...
            DefaultTableModel model = productDAO.buildTableModel(productDAO.getPurchaseInfo());
    ...
    public void loadSearchData(String text) {
        try {
            ProductDAO productDAO = new ProductDAO();
            DefaultTableModel model = productDAO.buildTableModel(productDAO.getPurchaseSearch(text));
            purchaseTable.setModel(model);
